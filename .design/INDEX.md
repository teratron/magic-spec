...
| [workflow-enhancements.md](specifications/workflow-enhancements.md) | Eight targeted improvements: handoffs, user stories, prerequisite validation, CONTEXT.md, explore mode, onboarding, CLI doctor, and delta hints | Draft | 0.3.0 |
...
| 1.16.0 | 2026-02-23 | Agent | Updated workflow-enhancements to v0.3.0 (added features inspired by OpenSpec analysis) |
