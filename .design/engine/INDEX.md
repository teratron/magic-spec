...
- **License**: MIT
- **Last Updated**: 2026-08-06 (Progress replacement-string injection: l1-session-continuity 1.5.1, l2-engine-finalization 1.8.0, l2-test-suite 1.11.0 — string-form `.replace()` against a capture-group regex let `$`-digit narrative text splice fence markup mid-document — informal field report, engine 2.1.58, investigated and reproduced independently)
