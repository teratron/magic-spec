...
- **License**: MIT
- **Last Updated**: 2026-06-12 (session continuity: l1-session-continuity.md + l2-status-command.md added; finalization/wrapper specs amended for SC-2/SC-3 and /magic.status inventory)
