...
| [l2-engine-automation.md](specifications/l2-engine-automation.md) | Automation scripts, history subsystem, execution logic, and coverage denominator scope (EXEMPT classification for SDD bookkeeping files, §Coverage Denominator Scope). | Stable | 2 | 1.7.0 |
