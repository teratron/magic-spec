...
| `/magic.dev.simulate` | Developer workflow for cognitive simulation and regression validation. |
| `/magic.dev.sync` | Developer workflow for metadata/version/documentation synchronization. |
| `/magic.dev.publish` | Developer workflow for publishing and release automation. |
...
| :--- | :--- | :--- | :--- |
| 1.0.1 | 2026-03-31 | Agent | Added developer workflows and corrected engine spec count. |
...
*Generated by Magic Spec Engine* (v1.5.109) on 2026-03-31
